...
public class Personaje {
     ...
     * 
     */
    public Personaje(int iX, int iY, Animacion aniAnimacion) {
        this.iX = iX;
        this.iY = iY;
     ...
     * 
     */
    public void setImageIcon(Animacion aniAnimacion) {
        this.aniAnimacion = aniAnimacion;
    }
     ...
     * getImageIcon
     * 
     * Metodo de acceso que regresa la del objeto 
     * 
     * @return aniAnimacion es el <code>icono</code> del objeto.
     * 
     */
